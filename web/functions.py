...
class Functions(threading.Thread):
	...
	def trackLineProcessing(self):
		...
		print('R%d  -%d  M%d   -%d  L%d'%(status_right,status_right_middle,status_middle,status_left_middle,status_left))
		if status_middle == 0:
			move.move(80, 'forward', 'no')
		elif status_left == 0:
			move.move(100, 'no', 'right')
			time.sleep(0.6)
			move.move(100, 'forward', 'right')
			time.sleep(0.6)
			
		elif status_left_middle == 0:
			move.move(100, 'no', 'right')
			time.sleep(0.6)
			move.move(100, 'forward', 'right')
			time.sleep(0.3)
		elif status_right == 0:
			move.move(100, 'no', 'left')
			time.sleep(0.6)
			move.move(100, 'forward', 'left')
			time.sleep(0.6)
		elif status_right_middle == 0:
			move.move(100, 'no', 'left')
			time.sleep(0.6)
			move.move(100, 'forward', 'left')
			time.sleep(0.3)
		else:
			# move.move(100, 'backward', 'no')
			# time.sleep(0.6)
			move.move(100, 'no', 'no')
		time.sleep(0.1)
	...
	def automaticProcessing(self):
		...
		if 20.0 > dist:#20cm     
			...
			move.move(100, 'no', 'left')
			time.sleep(0.5)
			move.move(100, 'backward', 'left')
			time.sleep(0.5)
			move.move(100, 'forward', 'right')
			time.sleep(0.5)
		else:
			move.move(100, 'forward', 'no')
		time.sleep(0.2)
