...
# Production  : BLONWINER 2 in 1 Robot
# Author      : BLONWINER
...
init_pwm0 = scGear.initPos[11]
init_pwm1 = scGear.initPos[12]
init_pwm2 = scGear.initPos[13]
init_pwm3 = scGear.initPos[14]
init_pwm4 = scGear.initPos[15]
...
def servoPosInit():
    scGear.initConfig(11,init_pwm0,1)
    scGear.initConfig(12,init_pwm1,1)
    scGear.initConfig(13,init_pwm2,1)
    scGear.initConfig(14,init_pwm3,1)
    scGear.initConfig(15,init_pwm4,1)
...
def ap_thread():
    os.system("sudo create_ap wlan0 eth0 BLONWINER_2in1_Robot 12345678")
...
def robotCtrl(command_input, response):
    ...
    if 'forward' == command_input:
        ...
        G_sc.singleServo(15, 1, 1)
    elif 'stop' in command_input:
        G_sc.stopWiggle()
        T_sc.stopWiggle()
        H2_sc.stopWiggle()

    elif 'up' == command_input: # camera
        T_sc.singleServo(11, -1, 1)
        ...
        P_sc.moveServoInit(14)
        G_sc.moveServoInit(15)
        T_sc.moveServoInit(11)
